...
In-depth teaching material for every MCAT topic. Files mirror `Content/` 1:1.

## Folder Structure (post-2026-04-28 Kaplan-book reorg)

```
research/
  INDEX.md                  <-- You are here (top-level routing)
...
1. **Identify the subject area** from the study topic or student question.
2. **Open the matching folder's INDEX.md** for chapter-level routing with trigger keywords.
3. **Load the matching ChNN file** plus its `Content/` mirror.
